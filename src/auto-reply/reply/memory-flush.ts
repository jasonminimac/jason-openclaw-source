...
const MEMORY_FLUSH_TARGET_HINT =
  "Store durable memories now (use MIND/logs/[CURRENT-MONTH]/YYYY-MM-DD.md; create MIND/logs/[CURRENT-MONTH]/ if needed).";
const MEMORY_FLUSH_APPEND_ONLY_HINT =
  "If MIND/logs/[CURRENT-MONTH]/YYYY-MM-DD.md already exists, APPEND new content only and do not overwrite existing entries.";
