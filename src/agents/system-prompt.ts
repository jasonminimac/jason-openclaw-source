...
function buildMemorySection(params: {
  ...
  const lines = [
    "## Memory Recall",
    "Before answering anything about prior work, decisions, dates, people, preferences, or todos: run memory_search on MEMORY.md + memory/*.md + MIND/* (logs, decisions, errors, profile, projects); then use memory_get to pull only the needed lines. If low confidence after search, say you checked.",
  ];
